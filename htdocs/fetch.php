                        ...
                        echo "<div class='col-md-6'>
                                <div class='card h-100 shadow-sm'>
                                    <a href='detail.php?itemID=$item1_id' target='_blank' class='card-link'>
                                        ...
                                        <div class='card-body'>
                                            <h5 class='card-title'><span class='bi bi-arrow-left-right' style='0.8rem;'></span> <strong></strong> $item1_name</h5>
                                        </div>
                                    </a>
                                </div>
                              </div>";
                        ...
                        echo "<div class='col-md-6'>
                                <div class='card h-100 shadow-sm'>
                                    <a href='detail.php?itemID=$item2_id' target='_blank' class='card-link'>
                                        ...
                                        <div class='card-body'>
                                            <h5 class='card-title'><span class='bi bi-arrow-left-right' style='0.8rem;'></span> <strong></strong> $item2_name</h5>
                                        </div>
                                    </a>
                                </div>
                              </div>";
                        ...
                        echo "<div class='col-md-6'>
                                <div class='card h-100 shadow-sm'>
                                    <a href='detail.php?itemID=$item3_id' target='_blank' class='card-link'>
                                        ...
                                        <div class='card-body'>
                                            <h5 class='card-title'><span class='bi bi-arrow-left-right' style='0.8rem;'></span> <strong></strong> $item3_name</h5>
                                        </div>
                                    </a>
                                </div>
                              </div>";
