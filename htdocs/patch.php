                        ...
                        echo "<div class='col-md-6'>
                                <div class='card h-100 shadow-sm'>
                                    <a href='detail.php?itemID=$item1_id' target='_blank' class='card-link'>
                                        ...
                                        <div class='card-body'>
                                            <h6 class='card-title'><span class='bi bi-arrow-left-right' style='font-size: 0.9rem;'></span> <strong></strong> $item1_name</h6>
                                        </div>
                                    </a>
                                </div>
                              </div>";
                        ...
                        echo "<div class='col-md-6'>
                                <div class='card h-100 shadow-sm'>
                                    <a href='detail.php?itemID=$item2_id' target='_blank' class='card-link'>
                                        ...
                                        <div class='card-body'>
                                            <h6 class='card-title'><span class='bi bi-arrow-left-right' style='font-size: 0.9rem;'></span> <strong></strong> $item2_name</h6>
                                        </div>
                                    </a>
                                </div>
                              </div>";
                        ...
                        echo "<div class='col-md-6'>
                                <div class='card h-100 shadow-sm'>
                                    <a href='detail.php?itemID=$item3_id' target='_blank' class='card-link'>
                                        ...
                                        <div class='card-body'>
                                            <h6 class='card-title'><span class='bi bi-arrow-left-right' style='font-size: 1rem;'></span> <strong></strong> $item3_name</h6>
                                        </div>
                                    </a>
                                </div>
                              </div>";
