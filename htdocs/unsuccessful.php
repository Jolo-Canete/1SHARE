    ...
    <div class="page-content" id="content">
        <div class="container">
            ...
            $query = "SELECT r.requestID, r.requestType, i.itemName, u.username AS itemOwner, r.request_DateTimeClosed
                      ...
                      WHERE r.userID = $user_id AND r.status = 'Declined'";
            ...
            ?>
                <div class="row">
                    ...
                    <div class="d-none d-md-block text-dark">
                            <h1 class="display-4 fw-bold text-dark text-center mt-3 mb-0"><i class="bi bi-x-circle" style="font-size: 2.8rem;"></i> UNSUCCESSFUL REQUESTS</h1>
                            <br>
                        </div>
                    </div>
                    </div>
                    <div class="d-md-none text-dark">
                    <h6 class="display-7 fw-bold text-dark text-center mt-4 mb-0"><i class="bi bi-x-circle" style="font-size: 1rem;"></i> UNSUCCESSFUL REQUESTS</h6>
                </div>
                </div>
                <br>
                <div class="row mb-3">
            ...
            <div class='container'>
                <h1 class='display-4 mt-5'>No Unsuccessful Requests</h1>
                <p class='lead text-secondary'>Looks like there are no unsuccessful requests at the moment.</p>
            </div>
        </div>";
            }
            ?>
            ...
            $(document).ready(function() {
                $('.modal').on('show.bs.modal', function(event) {
                    ...
                    if (modal.attr('id') === 'reqbartermodal') {
                        ...
                        fetchUrl = 'patchu2.php';
                    } else if (modal.attr('id') === 'reqBorrowModal') {
                        fetchUrl = 'patchu1.php';
                    }
