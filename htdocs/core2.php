...
if (isset($_GET['requestId'])) {
    ...
    $query = "SELECT r.*, b.*, i.*, u.username, i.itemID AS item_id, i.itemName AS item_name, i.itemImage_path AS item_image, r.userID AS rater, r.itemID AS item, r.requestID AS id, i.userID AS ownerID
              FROM Request r
