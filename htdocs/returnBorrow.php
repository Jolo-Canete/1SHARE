...
<head>
    <title>Return Borrow Item</title>
    <meta charset="utf-8" />
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card shadow-sm">
                            <div class="card-header bg-success text-white">
                                <h1 class="display-4 fw-bold text-center"><i class="bi bi-check-circle"></i> RETURN</h1>
                            </div>
                            <div class="card-body">
                                <p class="text-secondary mb-4">Please answer the following questions</p>
                                <form action="" method="post">
                                    <div class="mb-3">
                                        <label class="form-label"><b>Is the item returned?</b> <span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label for="proof" class="form-label"><b>Please provide a proof that the item is already returned (Optional)</b> </label>
