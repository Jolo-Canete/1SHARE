...
if (isset($_GET['requestId'])) {
    ...
    $sql = "SELECT Request.*, item.userID AS ownerID
            FROM Request
            JOIN barter ON Request.requestID = barter.requestID
            JOIN item ON Request.itemID = item.itemID
...
<head>
    <title>Receive Barter Item</title>
    <meta charset="utf-8" />
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            completeBtn.on('click', function(event) {
                ...
                $.ajax({
                    url: 'recieveBarter.php?requestId=' + encodeURIComponent(requestId),
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
